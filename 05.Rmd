# Most of Your Data is Almost Always Missing {#miss}
...
We'll use the data `ACT_IllLvlMainWithMalProbs_FINAL_pub.dta` from Cohen et al. (2015), which can be downloaded from the book's [Github page](https://github.com/tbendixen/DAG-companion/tree/main/docs) or [www.openicpsr.org](https://www.openicpsr.org/openicpsr/project/112911/version/V1/view?path=/openicpsr/112911/fcr:versions/V1/AER2013-0267_data-code&type=folder).
...
Kurz (REF)[<https://bookdown.org/content/4857/adventures-in-covariance.html#instruments-and-causal-designs>] gives a rundown of instrumental variable analysis using the `brms` package, building on McElreath (2020, REF), and we follow that general approach here. We refer to those sources for further details.
