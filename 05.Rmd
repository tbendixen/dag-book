...
census$proportion <- census$FREQUENCY / sum(census$FREQUENCY)
...
The poststratified marginal causal effect is around 2.3 kg but with a fairly wide 95% interval ranging from around 0 to 4.5 kg.
...
By inspecting the summary, we see that we get essentially the same results as above -- `act_voucher` corresponds to the Wald estimate -- except we now have a posterior distribution to work with.
