...
An alternative approach -- when we have a fitted model, Bayesian or otherwise -- is via the versatile and very well documented `marginaleffects` package [@R-marginaleffects].
