...
We then write a function for fitting and plotting our models that we can re-use for the 'Pipe' and 'Collider' scenarios. This function depends on the `{ggplot2}` and `{patchwork}` packages.
